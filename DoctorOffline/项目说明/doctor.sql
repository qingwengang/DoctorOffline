...
-- ----------------------------
-- Table structure for jkwquestion
-- ----------------------------
DROP TABLE IF EXISTS `jkwquestion`;
CREATE TABLE `jkwquestion` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `TypeName` varchar(50) DEFAULT NULL,
  `OutId` bigint(20) DEFAULT NULL,
  `SpiderFlag` int(11) DEFAULT NULL,
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=136120 DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for onlinemulu
-- ----------------------------
DROP TABLE IF EXISTS `onlinemulu`;
CREATE TABLE `onlinemulu` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `Name` varchar(50) DEFAULT NULL,
  `Level` int(11) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for onlinemulurelation
-- ----------------------------
DROP TABLE IF EXISTS `onlinemulurelation`;
CREATE TABLE `onlinemulurelation` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `OnlineMuluId` bigint(20) DEFAULT NULL,
  `Ask120Relation` varchar(200) DEFAULT NULL,
  `FHRelation` varchar(255) DEFAULT NULL,
  `JJRelation` varchar(255) DEFAULT NULL,
  `JKRelation` varchar(255) DEFAULT NULL,
  `SJRelation` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`Id`)
...
-- ----------------------------
-- Table structure for sjquestion
-- ----------------------------
DROP TABLE IF EXISTS `sjquestion`;
CREATE TABLE `sjquestion` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `TypeName` varchar(50) DEFAULT NULL,
  `OutId` varchar(50) DEFAULT NULL,
  `SpiderFlag` int(11) DEFAULT NULL,
